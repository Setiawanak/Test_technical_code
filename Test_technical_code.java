...
public class Test_technical_code {
    public static void main(String args[]) {
		...
		pilihanmenu = in.nextInt(); // PILIH MENU
		...
		switch (pilihanmenu) {
			case 1 : // Generate angka Segitiga
                ...
                // Pindahin dulu ke String biar nambah angka atau huruf biar lebih mudah (0-9 atau a-z)
                ...
                for (int w = 0; w < numberString.length(); w++) {
                    ...
                    nambahEnol = "0".repeat(w+1); // ikutin angka setiap  segitiga Contoh : 10 , 200 , 3000 , 4000 , 50000
            ...
            case 2 : // Generate Bilangan Ganjil
			    ...
			    (x % 2 == 0 ) { // Memeriksa bilangan genap
            ...
            case 3 : // Generate Bilangan Prima
			    ...
			    (x % 2 == 0 ) { // Memeriksa bilangan prima
